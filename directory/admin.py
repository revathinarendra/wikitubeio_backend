...
from .models import Course, Article, Content, VideoPlayer, Quiz, UserPerformance
...
class ArticleAdmin(admin.ModelAdmin):
    list_display = ('article_name', 'course_name', 'slug', 'article_video_url')
    search_fields = ('article_name', 'course_name__course_name')  # Search by article name and course name
